...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Button mRunCatModelButton;
    private Bitmap mSelectedImage;
    private GraphicOverlay mGraphicOverlay;
    private RecyclerView mRecyclerView;
    private FindTextAdapter mAdapter;
    ...
    private static final String CUSTOM_MODEL_NAME = "retrained_labels.txt";
    private static final String CUSTOM_MODEL_ASSET = "optimized_graph.tflite";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFlowerButton = findViewById(R.id.button_flower);
        mRunCatModelButton = findViewById(R.id.button_run_cat);



        // Get a handle to the RecyclerView.
        mRecyclerView = findViewById(R.id.recyclerview);
        mAdapter = new FindTextAdapter(this, mWordList);

        recyclerManager.setOrientation(LinearLayoutManager.VERTICAL);
        mRecyclerView.setLayoutManager(recyclerManager);
        ...
        mFlowerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //runCloudTextRecognition();
            }
        });
        mRunCatModelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                runModelInference();
            }
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<FirebaseVisionText>() {
                            ...
                            public void onSuccess(FirebaseVisionText texts) {
                                ...
                                processExtractedText(texts,mWordList);
                            }
                        })
    ...
    private void processExtractedText(FirebaseVisionText firebaseVisionText, List<String> list) {
        ...
        try {
            ...
            FirebaseLocalModelSource localSource =
                    new FirebaseLocalModelSource.Builder("asset")
                            .setAssetFilePath(CUSTOM_MODEL_ASSET).build();
            FirebaseModelManager manager = FirebaseModelManager.getInstance();
            manager.registerCloudModelSource(cloudSource);
            manager.registerLocalModelSource(localSource);
            FirebaseModelOptions modelOptions =
                    new FirebaseModelOptions.Builder()
                            .setCloudModelName(CUSTOM_MODEL_NAME)
    ...
    */
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 3:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "tulips.jpg");
                break;
            case 4:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "cat.jpg");
                break;
        }
        if (mSelectedImage != null) {
            // Get the dimensions of the View
